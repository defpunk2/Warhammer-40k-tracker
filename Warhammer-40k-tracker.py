...
class game_record_inplay:
    ...
    def layout(self):
        self.keywords = ["Faction","Player Name","Detachment","Vp 1","Cp 1","Vp 2","Cp 2","Vp 3","Cp 3","Vp 4","Cp 4","Vp 5","Cp 5"]
        keywords_posx = 200
        keywords_posy = 200
        values_posy = [300,500]
        values_posx = 175
    ...
    def assertItems(self):
        ...
        if "" in tocheck:
            for x in range(0,len(self.keywords)):
                if tocheck[x] == "":
                    self.missingitems.append(self.keywords[x])
        print(self.missingitems)
